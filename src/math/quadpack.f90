...
70  continue 
  ...
  subroutine dqawf ( f, a, omega, integr, epsabs, result, abserr, neval, ier )
    ...
    call dqawfe ( f, a, omega, integr, epsabs, limlst, limit, maxp1, &
  ...
  subroutine dqawfe ( f, a, omega, integr, epsabs, limlst, limit, maxp1, &
    ...
    integer numrl2
    real ( kind = 8 ) omega
    real ( kind = 8 ), parameter :: p = 0.9D+00
    real ( kind = 8 ), parameter :: pi = 3.1415926535897932D+00
    real ( kind = 8 ) p1
    real ( kind = 8 ) psum(52)
    real ( kind = 8 ) reseps
    real ( kind = 8 ) result
    ...
    if ( omega == 0.0D+00 ) then
       ...
       if ( integr == 1 ) then
          call dqagi ( f, 0.0D+00, 1, epsabs, 0.0D+00, result, abserr, neval, ier )
       else
          result = 0.0D+00
          abserr = 0.0D+00
          neval = 0
